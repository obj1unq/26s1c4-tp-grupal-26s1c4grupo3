...
1. Descargar e instalar Wollok desde [wollok.org](https://www.wollok.org/) (versión 4.2.3 o
   compatible).
2. **File → Open Folder** y seleccionar esta carpeta completa (`Linux-Mac`), no un archivo
   suelto.
...
2. Abrir una terminal **dentro de esta carpeta** (`Linux-Mac`).
3. Correr el juego:
   ```
